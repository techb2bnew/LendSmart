...
import LoanSupport from "@/components/LoanSupport";
...
export default function Home() {
  return (
    <main className="min-h-screen">
      <AnimateSection mode="fade-down" delay={0} className="overflow-visible">
        <Navbar />
      </AnimateSection>
      <AnimateSection delay={0.02}>
        <Hero />
      </AnimateSection>
      <AnimateSection delay={0.04}>
        <About />
      </AnimateSection>
      <AnimateSection delay={0.06}>
        <LoanServices />
      </AnimateSection>
      ...
      >
        <svg width="28" height="28" fill="white" viewBox="0 0 24 24" aria-hidden>
