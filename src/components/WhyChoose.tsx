...
export default function WhyChoose() {
  return (
    <section className="relative top-[-48px] overflow-hidden bg-[#F4FBE9] pt-20 sm:top-[-80px] sm:pt-28 lg:top-[-120px] lg:pt-36">
      <div className="page-container sm:px-6 lg:px-10">
        <div className="grid grid-cols-1 items-end gap-5 lg:grid-cols-[1.05fr_0.95fr] ">
          {/* Left content */}
          <div className="relative lg:pt-6 pb-20">
            <div className=" ">
              ...
              <a
                ...
                className="mt-7 inline-flex h-[42px] items-center gap-2 rounded-[3px] bg-[#1f1f1f] px-4 text-[13px] font-medium text-white transition hover:opacity-95"
              >
