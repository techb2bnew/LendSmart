...
export default function Testimonials() {
  ...
  return (
    <section
      id="testimonials"
      className="overflow-hidden bg-[#1E1E1E] py-14 lg:py-20"
    >
      <div className="page-container sm:px-6 lg:px-10">
        <div className="relative grid grid-cols-1 items-start lg:grid-cols-[1.15fr_0.85fr]">
          ...
          <div className="relative z-30 lg:pt-10">
            <div className=" ">
              ...
              <div className="mt-5 border-l-[5px] border-[#79c44a] pl-4">
                <p className="text-[15px] leading-7 text-[#b9b9b9]">
                  Clients trust LendSmart Mortgages for reliable loan guidance
                  and support.
                </p>
              </div>
            </div>
            ...
            <div className="relative mt-6 flex justify-center mb-4 gap-4 sm:gap-5 lg:justify-end lg:gap-5 xl:-mr-[230px]">
              <button
                type="button"
                onClick={handlePrev}
                className="group flex h-11 w-11 min-h-[44px] min-w-[44px] shrink-0 items-center justify-center rounded-full transition active:opacity-90"
